var BattleScene = new Phaser.Class({
    ...
    startBattle: function() {
        ...
        var mage = new PlayerCharacter(this, 250, 50, "player", 24, "Mage", 100, 15);      
        this.add.existing(mage);
        
        // player character - Warrior
        var warrior = new PlayerCharacter(this, 250, 100, "flavia", 8, "Warrior", 80, 10);
        ...
        // array with heroes
        this.heroes = [ mage, warrior ];
        // array with enemies
        this.enemies = [ merc, archer ];
        ...
        this.animation();
        mageAnims = this.physics.add.sprite(250, 50, 'player', 0);
        warriorAnims = this.physics.add.sprite(250, 100, 'player', 0);
        mercAnims = this.physics.add.sprite(50, 50, 'player', 0);
        archerAnims = this.physics.add.sprite(50, 100, 'player', 0);
    ...
    animation: function() {
        ...
        this.anims.create({
            key: 'idleFlavia',
            frames: this.anims.generateFrameNumbers('flavia', { start: 0, end: 3 }),
            frameRate: 5,
            yoyo: true,
            repeat: -1
        });
